...
Our variables after cleaning are:
...
animals are in the animal shelter and the general distribution.
...
``` r
# Is there a breed that has a higher adoption fee?
...
The scatterplots and the correlation coefficient show that there appears
...
The boxplots comparing health status and vaccination status against
adoption fees reveal that pets who are healthy and vaccinated generally
show similar adoption fees compared to those with medical conditions or
...
the boxplot for likely adopted pets is slightly shorter, indicating a
smaller interquartile range compared to the not likely group. This could
suggest that pets priced within a specific range are more consistently
adopted, whereas pets with adoption fees that are unusually high or
unusually low experience more variance and may face a harder time
finding a home.
...
Faceted by pet type, the boxplots investigate whether having a medical
condition prolongs a pet’s stay in the shelter. Across most categories,
pets with medical conditions (TRUE) show a similar median number of days
spent in the shelter compared to healthy pets (FALSE). At most, Cats and
Dogs with medical conditions have slightly lower median number of days
spent in the shelter, which seems to be counterintuitive but could also
indicate that they might pass away before getting adopted. Overall, it
can be seen that underlying health issues have little impact on how
quickly a pet is adopted.
...
The dodged bar chart tracks the prevalence of medical conditions as
animals age, revealing that age-related health trends vary by pet type.
For cats, there is a clear upward trajectory, with the proportion of
medical conditions increasing with age and spiking notably in the “Old
(\>7 years)” category. Conversely, dogs exhibit a downward trend,
presenting with fewer medical conditions in the older age groups. Birds
follow a distinct “U-shaped” pattern, indicating higher rates of medical
issues in both the youngest and oldest groups, but a lower rate during
their adult years. Meanwhile, the rate for rabbits remains relatively
stable across all age brackets. This demonstrates that while age is an
important factor in shelter health, its specific impact is highly
dependent on the species of the animal.
...
The horizontal bar chart ranks specific breeds based on their likelihood
of presenting with a medical condition. At the top of the chart, the
Poodle shows the highest proportion of health issues. This could point
to genetic predispositions within that specific breed, or it may reflect
the typical background and prior care quality of these animals before
they were surrendered to the shelter. At the bottom of the char,
Labradors have the lowest proportion of health issue, which again could
point to genetic factors.
...
This final bar chart directly addresses whether a medical condition
could deter potential adopters. By comparing the overall adoption rates,
we can see that pets without a medical condition (FALSE) have an
adoption rate close to 40%, while pets with medical conditions (TRUE)
have a rate close to 10%. This demonstrates that health status is a
significant barrier when it comes to finding a forever home for these
animals.

## Conclusion

Through our exploration of the Pet Adoption dataset, we aimed to
identify the primary factors that influence a pet’s likelihood of
adoption and their length of stay in a shelter. After cleaning and
analyzing the data, we found that while some variables have a clear
impact, the overall adoption process is highly nuanced.

Based on our analysis, we have drawn the following key conclusions:

- Health and Pet Type are The Biggest Drivers of Adoption

  - The data strongly indicates that a pet’s species and health
    conditions are the most critical determining factors for adoption.
    Dogs (particularly Labradors) and pets with no underlying medical
    conditions have the highest probability of finding a home. Medical
    conditions act as a significant barrier to adoption, dropping the
    likelihood from near 40% to roughly 10%.

- Time in Shelter is Unpredictable

  - Traditional metrics do not tightly correlate with a pet’s length of
    stay. Variables such as a pet’s age, adoption fee, and even medical
    condition show little to no linear relationship with how many days
    they spend in the shelter.

- Adoption Fees are Static

  - Shelters in this dataset do not appear to dynamically adjust pricing
    based on a pet’s size, vaccination status, or medical needs.
    Furthermore, the cost of adoption does not significantly deter or
    encourage potential adopters, indicating that pricing is not a
    primary hurdle for families looking to adopt.

- Actionable Advice for Shelters

  - Because health status is the most significant barrier to adoption,
    shelters should prioritize veterinary resources to treat medical
    conditions prior to listing pets for adoption. Additionally, since
    breed and color influence adoption rates, shelters should focus
    their marketing and social media efforts on highlighting specific
    under-adopted groups.

- Future Analysis Requires Complex Modeling

  - Because there are few strong, isolated trends regarding shelter time
    and adoption fees, a pet’s ultimate likelihood of being adopted is
    likely based on complex, intersecting combinations of variables. To
    accurately predict adoption outcomes, future studies would benefit
    from advanced multivariate analysis and machine learning models.
